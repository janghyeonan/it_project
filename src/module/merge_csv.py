...
# -*- coding: utf-8 -*-
"""
Created on Sun Apr 22 01:26:52 2018
...
def total_csv(year1,year2):
    for i in range(year1,year2+1):
        ...
        data = pd.read_csv("/home/itwill02/project/test/data/"+str(i)+".csv")
        ...
        data1 = pd.read_csv("/home/itwill02/project/test/data/mdict"+str(i)+".csv")
        ...
        a1 = a.set_index('code')
        a1.to_csv('/home/itwill02/project/test/data/'+str(i)+'.csv',mode='w',encoding='utf-8')
        print('머지 완료 ')
